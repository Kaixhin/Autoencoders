...
function Model:createAutoencoder(X)
  ...
  self.decoder:add(nn.SpatialFullConvolution(8, 8, 4, 4, 2, 2, 1, 1))
  self.decoder:add(nn.ReLU(true))
  self.decoder:add(nn.SpatialFullConvolution(8, 16, 4, 4, 2, 2, 1, 1))
  self.decoder:add(nn.ReLU(true))
  self.decoder:add(nn.SpatialFullConvolution(16, 1, 4, 4, 2, 2, 3, 3))
