...
decoder:add(nn.SpatialFullConvolution(8, 8, 4, 4, 2, 2, 1, 1))
decoder:add(nn.ReLU(true))
decoder:add(nn.SpatialFullConvolution(8, 16, 4, 4, 2, 2, 1, 1))
decoder:add(nn.ReLU(true))
decoder:add(nn.SpatialFullConvolution(16, 1, 4, 4, 2, 2, 3, 3))
